...
XTrain = csvread('AllTrainX.csv');
%YTrain = csvread('AllTrainY.csv');
[~,~,YTrain] = xlsread('AllTrainY.csv');
XTest = csvread('AllTestX.csv');
%YTest = csvread('AllTestY.csv');
[~,~,YTest] = xlsread('AllTestY.csv');
